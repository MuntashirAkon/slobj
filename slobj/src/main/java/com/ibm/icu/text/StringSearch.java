// Source: https://gist.github.com/ncruces/fed041b5cac611f413267cf674ce2e4f
/*
 *******************************************************************************
...
public final class StringSearch extends SearchIterator {
     ...
     *                should be used.
     * @throws ClassCastException thrown if the collator for the specified
    ...
    protected int handleNext(int start) {
        ...
        while (index <= target.getEndIndex()) {
            ...
            if (DEBUG)
                debug(" outer loop: patIndex=" + patIndex + ", index=" + index + ", iter offset= " + iter.getOffset());
    ...
    private final int[] shiftTable = new int[MAX_TABLE];
    private final int[] backShiftTable = new int[MAX_TABLE];
